...
class OBJECT_OT_bake_vertex_normals(bpy.types.Operator):
    ...
    merge_axis: bpy.props.EnumProperty(
        name="Merge Axis", items=[("NONE", "None", "", 0), ("X", "X", "", 1), ("Y", "Y", "", 2), ("Z", "Z", "", 3)]
    )
