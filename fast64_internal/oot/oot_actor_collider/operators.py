...
from ..oot_constants import ootEnumColliderShape
from ...utility import PluginError, parentObject, raisePluginError, copyPropertyGroup
from .utility import updateColliderOnObj, addColliderThenParent
...
oot_actor_collider_ops_classes = (
    OOT_AddActorCollider,
    OOT_CopyColliderProperties,
)


def oot_actor_collider_ops_register():
    for cls in oot_actor_collider_ops_classes:
        register_class(cls)


def oot_actor_collider_ops_unregister():
    for cls in reversed(oot_actor_collider_ops_classes):
