...
from .utility import updateCollider
...
oot_actor_collider_props_classes = (
    OOTColliderLayers,
...
def oot_actor_collider_props_register():
    for cls in oot_actor_collider_props_classes:
        register_class(cls)
...
def oot_actor_collider_props_unregister():
    for cls in reversed(oot_actor_collider_props_classes):
