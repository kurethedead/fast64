...
class OOT_CollisionPanel(bpy.types.Panel):
    ...
    @classmethod
    def poll(cls, context):
        return (context.scene.gameEditorMode == "OOT" and context.material is not None) and not (
            context.object is not None and context.object.ootGeometryType == "Actor Collider"
        )
